      ...
      <div className="flex flex-wrap items-center justify-between gap-3 mb-6">
        ...
        <div className="flex flex-wrap gap-2 items-center">
          ...
          <Button variant="outline" size="sm" className="h-8 gap-1 text-xs" onClick={() => {
            ...
            const rows = filtered.map((o: any) => `${fmtDate(new Date(o.createdAt))},${o.orderRef || ""},${o.customerName || o.tableNumber || ""},${o.orderType},${o.status},${o.paymentStatus || ""},\u00a3${Number(o.total ?? 0).toFixed(2)}`);
          ...
          <Button variant="outline" size="sm" className="h-8 gap-1 text-xs" onClick={() => {
            ...
            filtered.forEach((o: any) => { html += `<tr><td>${fmtDate(new Date(o.createdAt))}</td><td>${o.orderRef || ""}</td><td>${o.customerName || o.tableNumber || ""}</td><td>${o.orderType}</td><td>${o.status}</td><td>${o.paymentStatus || ""}</td><td>\u00a3${Number(o.total ?? 0).toFixed(2)}</td></tr>`; });
